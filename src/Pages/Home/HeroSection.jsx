    ...
    return (
        ...
        <div className="hero--section--content">
            <p className="section--title">Hey, I am Mohsinali</p>
                ...
                I am an enthusiastic and motivated web developer with hands-on experience of 9-months at Mak byte in HTML, CSS, JavaScript, and React.js for creating responsive and engaging user interfaces.
                <br/>
                <br/>
